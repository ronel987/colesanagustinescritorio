...
import controlador.ControladorGra;
import java.sql.PreparedStatement;
import java.sql.ResultSet;
import javax.swing.DefaultComboBoxModel;
import modelo.Conexion;

public class FormGrado extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        FormGrado v = new FormGrado();
        ControladorGra a = new ControladorGra(v);
        v.setVisible(true);
