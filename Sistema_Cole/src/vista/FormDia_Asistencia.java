...
import controlador.Controlador_DiaAsisten;
...
public class FormDia_Asistencia extends javax.swing.JFrame {

    DefaultComboBoxModel combo;
    public FormDia_Asistencia() {
        initComponents();
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(cbxHorario, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(54, 54, 54))
        );
    ...
    public static void main(String args[]) {
        FormDia_Asistencia v= new FormDia_Asistencia();
        Controlador_DiaAsisten a = new Controlador_DiaAsisten(v);
        v.setVisible(true);
    ...
    public void cargarlistaHorarios() {
       ...
       try {
            ...
            while(res.next()){
                 combo.addElement(res.getString("dia"));
             }
           cbxHorario.setModel(combo);
           //con.desconectar();
         } catch (Exception e) {
