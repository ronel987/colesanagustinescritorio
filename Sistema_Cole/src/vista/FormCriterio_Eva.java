...
import controlador.ControladorCriteriosEva;
...
public class FormCriterio_Eva extends javax.swing.JFrame {

    DefaultComboBoxModel combo;
    public FormCriterio_Eva() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(40, 40, 40)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(txtDescripcion, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 138, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        FormCriterio_Eva v= new FormCriterio_Eva();
        ControladorCriteriosEva s = new ControladorCriteriosEva(v);
        v.setVisible(true);
    ...
    public void cargarlistaCursos() {
       ...
       try {
            ...
            while(res.next()){
                 combo.addElement(res.getString("nombre"));
             }
           cbxCurso.setModel(combo);
           //con.desconectar();
         } catch (Exception e) {
